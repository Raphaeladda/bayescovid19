...
def run(load_results = False):
    ...
    if load_results:
        # load saved results
        with open('results_France_idf.sav', 'rb') as results_file:
        ...
        config = {'country': 'France',
                  'regions': ['75', '77', '78', '91', '92', '93', '94', '95'],
                  'N' : 12.21e6,                    # Population size
        ...
        if config['save_results']:
            ...
            with open('results_France_idf.sav', 'wb') as results_file:
